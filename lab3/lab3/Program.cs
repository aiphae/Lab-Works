...
class StringArray
{
    [JsonProperty] private string[] Array { get; set; }
    [JsonProperty] private int Length { get; set; }
...
class Program
{
    static void Main()
    {
        ...
        Console.WriteLine("\nJSON: ");
        array2.ToJson("../../../array.json");
        var array3 = new StringArray();
        array3.FromJson("../../../array.json");
        array3.Print();
